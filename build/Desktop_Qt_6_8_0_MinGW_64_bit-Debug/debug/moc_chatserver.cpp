...
void ChatServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->onMessageReceived(); break;
        ...
        }
        {
            ...
            if (_t _q_method = &ChatServer::newMessageReceived; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void ChatServer::newMessageReceived(const QString & _t1)
{
